...
class Login extends CI_Controller{
	...
	public function proses_login(){
		if($this->input->post('role') === 'Bag Pembelian') $this->_proses_login_petugas($this->input->post('username'));

		elseif($this->input->post('role') === 'Pembelian') $this->_proses_login_admin($this->input->post('username'));
